...
class MissionSegmentProfile(BaseModel):
    ...
    outbound_altitude_m: float | None = Field(default=None, ge=0)

    loiter_duration_min: float | None = Field(default=None, gt=0)
    loiter_altitude_m: float | None = Field(default=None, ge=0)

    return_distance_km: float | None = Field(default=None, gt=0)
    return_altitude_m: float | None = Field(default=None, ge=0)
