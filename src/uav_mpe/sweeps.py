        ...
        rows.append(
            {
                ...
                "propulsion_electrical_power_w": propulsion_electrical_power_required_watts(sweep_config),
                "hotel_load_w": hotel_load_watts(sweep_config),
                "payload_load_w": payload_load_watts(sweep_config),
                "non_propulsive_electrical_load_w": non_propulsive_electrical_load_watts(sweep_config),
